...
def get_hand_hist():
    """Load the hand histogram for backprojection."""
...
def store_in_db(g_id, g_name):
    """Store gesture information in the database."""
    conn = sqlite3.connect("gesture_db.db")
...
def store_images(g_id):
    ...
    while True:
        ...
        if len(contours) > 0:
            ...
            print("No contours found. Adjust hand position or lighting.")
        ...
        if pic_no == total_pics:
            print(f"Captured {total_pics} images. Exiting...")
            break
        if keypress == ord('q'):
            print("Quit requested. Exiting without completing.")
            break
